...
class HotelRoom():
    ...
    def calculate_total(self):
        ...
        return f"Total Calculate: {total}"

    def display_info(self):
        return f"ID: {self.room_id} | Type: {self.room_type} | Price: {self.price_per_night} | Nights: {self.nights}"


call_room = HotelRoom("R000","Type",000,00)
print(call_room.calculate_total())
print(call_room.display_info())
...
class StandardRoom(HotelRoom):
    ...
    def display_info(self):
        return f"{self.room_id} {self.room_type} price={self.calculate_total()} nights={self.nights}"
    
call_stand = StandardRoom("R001", 500000, 2)
print(call_stand.display_info())
...
class DeluxeRoom(HotelRoom):
    ...
    def display_info(self):
        return f"{self.room_id} {self.room_type} price={self.calculate_total()} nights={self.nights} service_fee={self.service_fee}"

call_delux = DeluxeRoom("R002", 800000, 3, 120000, )
print(call_delux.display_info())
...
class SuiteRoom(HotelRoom):
    ...
    def display_info(self):
        return f"{self.room_id} {self.room_type} price={self.calculate_total()} nights={self.nights} service_fee={self.service_fee} luxury_tax={self.luxury_tax}"

call_suit = SuiteRoom("R003", 1500000,2, 200000,100000)
print(call_suit.display_info())
